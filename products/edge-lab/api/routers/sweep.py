...
from edge_core.registry.backtest_registry import create_backtest_run, create_backtest_folds
...
def backtest_sweep_ep(payload: BacktestSweepRequest):
    ...
    try:
        ...
        out_dir = _P('products/edge-lab/reports'); out_dir.mkdir(parents=True, exist_ok=True)
