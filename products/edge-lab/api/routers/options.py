...
from edge_core.registry.signals_registry import (
    fetch_signals as db_fetch_signals,
    upsert_option_signals as db_upsert_option_signals,
)
try:
    from edge_core.registry.signals_registry import replace_option_signals as db_replace_option_signals
except Exception:
    db_replace_option_signals = None
from edge_core.data.sources.polygon import get_polygon_hourly_bars
try:
    from edge_core.registry.signals_registry import fetch_option_signals as db_fetch_option_signals
except Exception:
    db_fetch_option_signals = None
from edge_core.data.sources.polygon import get_polygon_option_chain_snapshot, get_polygon_option_quotes
