    ...
    wrap.innerHTML = 
      ...
      '<div class="filters-bar">' +
        ...
        '<div class="filters-right">' +
          ...
          '<div class="filter-chip pack-badge zeroedge" id="filter-zeroedge">ZeroEdge</div>' +
          '<div class="filter-chip pack-badge swingedge" id="filter-swingedge">SwingEdge</div>' +
          '<div class="filter-chip pack-badge momentumedge" id="filter-momentumedge">MomentumEdge</div>' +
          '<div class="filter-chip pack-badge longedge" id="filter-longedge">LongEdge</div>' +
        '</div>' +
      '</div>' +
              ...
              '<div class="form-grid">' +
                ...
                '<div class="form-group">' +
                  ...
                  '<select class="form-input" id="build-pack">' +
                    '<option value="zeroedge" selected>ZeroEdge</option>' +
                    '<option value="swingedge">SwingEdge</option>' +
                    '<option value="longedge">LongEdge</option>' +
                    '<option value="overnightedge">OvernightEdge</option>' +
  ...
  function viewDocs() {
    ...
    wrap.innerHTML = 
      '<div class="page-header">' +
        ...
        '<p class="page-description">Edge Lab guides and API reference</p>' +
      '</div>' +
      '<div class="docs-grid">' +
        '<div class="doc-card">' +
          '<h3>Getting Started</h3>' +
          '<p>Learn the basics of Edge Lab and create your first model.</p>' +
        '</div>' +
        '<div class="doc-card">' +
          '<h3>API Reference</h3>' +
