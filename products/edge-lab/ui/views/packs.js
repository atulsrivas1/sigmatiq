      ...
      <div class="packs-grid">
        <div class="pack-card" data-pack="zeroedge">
          <div class="pack-header">
            ...
            <div class="pack-info">
              <h3 class="pack-name">ZeroEdge</h3>
        ...
        <div class="pack-card" data-pack="swingedge">
          <div class="pack-header">
            ...
            <div class="pack-info">
              <h3 class="pack-name">SwingEdge</h3>
        ...
        <div class="pack-card" data-pack="longedge">
          <div class="pack-header">
            ...
            <div class="pack-info">
              <h3 class="pack-name">LongEdge</h3>
        ...
        <div class="pack-card" data-pack="overnightedge">
          <div class="pack-header">
            ...
            <div class="pack-info">
              <h3 class="pack-name">OvernightEdge</h3>
        ...
        <div class="pack-card" data-pack="momentumedge">
          <div class="pack-header">
            ...
            <div class="pack-info">
              <h3 class="pack-name">MomentumEdge</h3>
