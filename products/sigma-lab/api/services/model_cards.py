...
def write_model_card(
    *,
    ...
    """Write a model card JSON and Markdown under packs/<pack>/model_cards/<model_id>/.
    ...
    # Basic policy execution summary
    ...
    if metrics:
        ...
        # show a few top-level metrics when available
...
def list_model_cards(*, pack_id: str, model_id: str) -> List[Dict[str, Any]]:
    ...
    # latest first by created_at then filename
